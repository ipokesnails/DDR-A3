	...
	Def.ActorFrame{
		...
		Def.Quad{
			...
			OnCommand=function(s) 
				...
				s:blend(Blend.Multiply):sleep(timeloop-0.2)
		...
		Def.Sprite{
			...
			OnCommand=function(s) 
				...
				s:linear(0.1):zoomy(1):sleep(timeloop)
				s:linear(0.1):zoomx(1.5):zoomy(0):sleep(0):diffusealpha(0)
			end,
		},
		Def.ActorFrame{
			OnCommand=function(s) s:sleep(timeloop):queuecommand("Stop") end,
		...
		LoadActor("footer.png")..{
			...
			OnCommand=function(s) 
				...
				s:linear(0.1):zoomx(1):linear(0.1):y(214):sleep(timeloop)
		...
		Def.Sprite{
			...
			OnCommand=function(s) 
				...
				s:linear(0.1):y(-214):sleep(timeloop)
				s:linear(0.1):zoomx(2):y(0):sleep(0.05):diffusealpha(0) 
			end,
		},
	};
